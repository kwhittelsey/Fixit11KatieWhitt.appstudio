...
const cacheName = 'Fixit11KatieWhitt-2020-04-02 14:01:22.550656'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit11KatieWhitt'.length) === 'Fixit11KatieWhitt') {
